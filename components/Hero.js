        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            ...
            <Popover.Group as="nav" className="hidden md:flex space-x-10">
              ...
              <a href="support" className="text-base font-medium text-gray-500 hover:text-gray-900">
                support
              </a>
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <a href="services" className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
                Services
              </a>
              <a
                href="signin"
        ...
        <div className="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
          <div className="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              <span className="block xl:inline">BEUTY & HAIR SALON</span>{' '}
